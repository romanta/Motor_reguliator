...
void loop() {
 ...
 m_curent  = map( m_curent, 511, 1023, 0, 29000); // преобразуем значение датчика тока в удобоваримый формат тока / Датчик на 30 Амперов
  ...
  //       start_motor = 0;
  //
  if (delta_KD > 950 || delta_WH >= 1000 || delta_WH <= 160 ) { //если значение таймера дельты2 больше "" или дельты1 больше ""
